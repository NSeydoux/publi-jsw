...
The relation between a node $n_p$ and its child $n_c$ is expressed with the triplet \triplet{$n_p$}{lmu:hasDownstreamNode}{$n_c$}\footnote{Namespaces are available on \url{http://prefix.cc}}\footnote{Individuals such as $n_p$ and $n_c$ are identified with an \gls{iri} in the triplets}, based on a nomenclature presented in \cite{Seydoux2017}. 
